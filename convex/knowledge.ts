...
export const ingestSoraChainQuick = action({
    ...
    handler: async (ctx) => {
        const sections = [
            {
                section: "Founder Bio - Swayam Shah",
                content: "Swayam Shah (CEO) - Ex-Binance/BNB Chain Research Lead. 9+ years in blockchain ecosystems. Led core research for BNB Chain, supported BNB Grants Program, and performed diligence for Binance Labs. Built early community at Hedera Hashgraph. MSc Computer Science. Brings deep expertise in protocol design, cryptoeconomics, and system design."
            },
            {
                section: "Co-Founder Bio - Franky Upadhyay",
                content: "Franky Upadhyay (CTO) - Deep-tech engineer with 10+ years in AI systems, GPU pipelines, and immersive computing. Led computer vision/XR for global projects (The Lion King, UAE gov). Previously at Cognizant and Gameln. Expert in AI architecture, system optimization, and large-scale compute orchestration."
            },
            {
