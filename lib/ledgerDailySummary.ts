...
export function buildLedgerUpdateTaskDescription(dateKey: string, summary: string): string {
  return [
    "Objective: update project ledger based on today's actual work.",
    "Files to update:",
    "- /Users/swayam/clawd/mission-control/PROJECT_LEDGER.md (canonical)",
    "- /Users/swayam/clawd/mission-control/memory/MEMORY.md (curated long-term memory)",
    "- /Users/swayam/clawd/mission-control/memory/DISTILLATION_TEMPLATE.md (distillation checklist)",
    "- /Users/swayam/clawd/PROJECT_LEDGER.md (workspace snapshot if needed)",
    `- /Users/swayam/clawd/memory/${dateKey}.md (log the update action and summary)`,
    "",
    summary,
    "",
    "Requirements:",
    ...
    "- Keep structure consistent with existing ledger sections.",
    "- If no material changes happened, add a short 'no material updates' entry.",
    "",
    "Debug requirement:",
