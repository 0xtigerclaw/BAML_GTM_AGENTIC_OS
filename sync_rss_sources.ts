...
const PACK_TO_SCRIPT: Record<Pack, string> = {
  olshansk: "import_olshansk_feeds.ts",
  "neolabs-google": "import_neolabs_feeds.ts",
  "neolabs-official": "sync_neolabs_official_sources.ts",
  "neolabs-proxy": "sync_neolabs_proxy_sources.ts",
};
