...
export default function SkillEditor() {
    ...
    const skillId = (Array.isArray(params.skillId) ? params.skillId[0] : params.skillId) as Id<"skills"> | undefined;

    const skill = useQuery(api.skills.get, skillId ? { id: skillId } : "skip");
    const resources = useQuery(api.skills.getResources, skillId ? { skillId } : "skip");
    ...
    if (!skillId) return <div className="p-8">Invalid skill ID.</div>;
